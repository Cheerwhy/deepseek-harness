...
export const zh = {
  ...
  'chat.turnCompleted': '第 {turn} 轮已完成工作',
  'chat.turnStopped': '第 {turn} 轮已停止',
  'chat.turnFailed': '第 {turn} 轮处理失败',
  ...
  'settings.transcript.classic': '经典',
...
export const en = {
  ...
  'chat.turnCompleted': 'Turn {turn} completed',
  'chat.turnStopped': 'Turn {turn} stopped',
  'chat.turnFailed': 'Turn {turn} failed',
  ...
  'settings.transcript.classic': 'Classic',
