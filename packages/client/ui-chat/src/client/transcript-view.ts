...
import {
  DEFAULT_TRANSCRIPT_VIEW_MODE, LEGACY_EXPANDED_TRANSCRIPT_VIEW_MODE, TRANSCRIPT_VIEW_FIELD,
...
export class TranscriptViewPolicy {
  ...
  /** Reactive current mode; defaults to Normal before Host settings arrive. */
   ...
   * @param mode - Classic, Compact, Standard, Detailed, or Verbose work details.
   */
  ...
  private adopt(): void {
    ...
    const mode = saved === LEGACY_EXPANDED_TRANSCRIPT_VIEW_MODE ? 'detailed' : saved
